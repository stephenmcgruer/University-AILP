...
# input-patterns to test (0 or 1), the reference
...
# Get the correct input for even (0) or odd (1)
# depending on the pattern.

case $1 in
  "0")
    # --- Even-numbered inputs, odd reference ---
    LISTFILES="../CV-LISTS/list-cv2-1"
    ;;
  "1")
    # --- Odd-numbered inputs, even reference ---
    LISTFILES="../CV-LISTS/list-cv2-1"
    ;;
  *  )
    echo "Unrecognized k-fold validation number. Number must be one of '0' or '1'."
    exit 1
    ;;
esac
shift
